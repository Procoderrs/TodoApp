...
function App() {
  ...
  const [showInput, setShowInput] = useState(false) // New state for toggling input display
    ...
    <>
      ...
      <div className="todolist mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-[#f7f8ff] min-h-[100vh] md:w-[60%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          <h2 onClick={() => setShowInput(!showInput)} className='text-2xl font-medium bg-[#616fed] max-w-40 text-center p-2 rounded-md text-white cursor-pointer'>
            Add Task
          </h2>
          {showInput && (  // Conditionally render input and button
            <div className="flex">
